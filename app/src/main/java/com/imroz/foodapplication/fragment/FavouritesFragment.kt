...
//    }
    ...
    class FavouritesAsync(context: Context) : AsyncTask<Void, Void, List<RestaurantEntities>>() {
        val db = Room.databaseBuilder(context, RestaurantDatabase::class.java, "res-db").build()
        override fun doInBackground(vararg params: Void?): List<RestaurantEntities> {
