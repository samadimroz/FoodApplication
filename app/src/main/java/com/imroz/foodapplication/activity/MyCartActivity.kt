...
//        toolbar.setTitleTextAppearance(this, R.style.PoppinsTextAppearance)
    ...
    private fun setUpCartList() {
        ...
        * of food items*/
        ...
        cartItemAdapter = CartItemAdapter(orderList, this@MyCartActivity)
        val mLayoutManager = LinearLayoutManager(this@MyCartActivity)
    ...
    private fun sendServerRequest() {
        ...
        jsonParams.put(
            "user_id",
            this@MyCartActivity.getSharedPreferences("FoodApp", Context.MODE_PRIVATE).getString(
                "user_id",
                null
            ) as String
        )
